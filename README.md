...
| :--- | :--- | :--- | :--- | :--- |
| **Super Admin 1** | Super Administrator | `superadmin@pandarealty.co.ke` | `SuperAdmin@2026!` | [`admin/super-admin-login.php`](admin/super-admin-login.php) |
| **Super Admin 2 (CEO)** | Perpetuah Chepchirchir | `perpetuah@pandarealty.co.ke` | `Perpetuah@2026!` | [`admin/ceo-login.php`](admin/ceo-login.php) |
| **Technical Admin** | TekTrend Admin | `admin@tektrend.co.ke` | `Admin@2026!` | [`admin/login.php`](admin/login.php) |
| **Client / User** | Demo Client | `test1@gmail.com` | `GoogleAuth@2026!` | [`login.php`](login.php) |

---

## 🌟 Key Features

### 1. 📱 TikTok / Reels Scrolling & Cinema Split View ([`videos.php`](videos.php))
...
- Available across **Admin Add Property** ([`admin/property-add.php`](admin/property-add.php)), **Admin Edit Property** ([`admin/property-edit.php`](admin/property-edit.php)), and **Client Listing Portal** ([`list-property.php`](list-property.php)):
...
### 3. 💼 Executive CRM & Deal Pipeline with Video Modal ([`admin/crm.php`](admin/crm.php))
...
## 🚀 Quick Setup (XAMPP / Localhost)

1. **Location**: Ensure the folder is in `c:\xampp\htdocs\pandarealty\`.
2. **Start Services**: Open XAMPP Control Panel and start **Apache** and **MySQL**.
3. **Access the Application**:
   - Website: [`http://localhost/pandarealty/`](http://localhost/pandarealty/)
   - Video Library & TikTok Reels: [`http://localhost/pandarealty/videos.php`](http://localhost/pandarealty/videos.php)
   - Staff & Admin Portal: [`http://localhost/pandarealty/admin/login.php`](http://localhost/pandarealty/admin/login.php)
   - Real Estate CRM: [`http://localhost/pandarealty/admin/crm.php`](http://localhost/pandarealty/admin/crm.php)
   - Client Listing Portal: [`http://localhost/pandarealty/list-property.php`](http://localhost/pandarealty/list-property.php)
